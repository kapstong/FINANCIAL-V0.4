...
<body class="min-h-screen text-[15px] text-[var(--ink)] bg-soft">
  ...
  <div id="contextBar" class="sticky top-14 z-40 border-b border-[var(--ring)] bg-white/80 backdrop-blur">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-12 flex items-center justify-between">
      <div class="flex items-center gap-3">
        <span class="font-semibold" style="color: var(--ink)">Disbursement</span>
      </div>
          ...
          <div class="mt-4 border-t border-[var(--ring)] pt-4">
            <div class="overflow-x-auto">
              <table class="min-w-full text-sm">
                <thead style="background: rgba(249, 115, 22, 0.1); border-color: rgba(249, 115, 22, 0.3)">
                  <tr>
                    <th class="text-left px-3 py-2" style="color: var(--ink)">Date</th>
                    <th class="text-left px-3 py-2" style="color: var(--ink)">Reference</th>
                    <th class="text-left px-3 py-2" style="color: var(--ink)">Description</th>
                ...
                <tbody>
                  <tr class="border-t" style="border-color: rgba(71,85,105,.3)">
                    ...
                    <td class="px-3 py-2" style="color: var(--ink)">DSB-0001</td>
                    <td class="px-3 py-2" style="color: var(--ink)">Sample for <b>${tab.label}</b></td>
                    <td class="px-3 py-2" style="color: var(--ink)">₱930.00</td>
                    <td class="px-3 py-2">
                      <a href="#" style="color: var(--brand)" class="font-semibold hover:underline">View</a>
                      <a href="#" style="color: var(--muted)" class="ml-3 hover:underline">Edit</a>
                      <a href="#" style="color: #dc2626" class="ml-3 hover:underline">Delete</a>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <div class="mt-5 grid grid-cols-1 md:grid-cols-2 gap-5">
              <div class="card p-4">
                <div class="font-semibold mb-2" style="color: var(--ink)">Insight</div>
                <p class="text-sm" style="color: var(--muted)">Replace with KPIs/charts for <b>${tab.label}</b>.</p>
              </div>
              <div class="card p-4">
                <div class="font-semibold mb-2" style="color: var(--ink)">Notes</div>
                <p class="text-sm" style="color: var(--muted)">This is a placeholder area. The loader wraps all actions.</p>
              </div>
            </div>
          </div>
        </section>
      ...
      if (progress >= 100) {
        ...
        setTimeout(() => {
          ...
          setTimeout(() => {
            ...
            // Add smooth content reveal animation
  ...
  // Animate content reveal with smooth transitions
  function animateContentReveal() {
    const contentElements = document.querySelectorAll('main .card, main .space-y-6 > *');
