  ...
  <header class="sticky top-0 z-50 border-b border-[var(--ring)] navbar backdrop-blur">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-14 flex items-center gap-3">
      ...
      <div class="relative">
        ...
        <div id="profileMenu" class="hidden absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden text-[var(--ink)]">
  ...
  <div id="contextBar" class="sticky top-14 z-40 border-b border-[var(--ring)] bg-white/80 backdrop-blur">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-12 flex items-center justify-between">
      <div class="flex items-center gap-3">
        <span class="font-semibold" style="color: var(--ink)">Accounts Receivable</span>
      </div>
          ...
          <div class="mt-6 space-y-6">
            ...
            <div class="bg-slate-50 border border-slate-200 rounded-lg p-4">
              <div class="flex flex-wrap gap-4 items-end">
                ...
                <div>
                  <label class="block text-sm font-medium mb-2" style="color: var(--muted)">Status</label>
              ...
              <table class="min-w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-100">
                  <tr class="hover:bg-slate-50 transition-colors">
                    ...
                    <td class="px-4 py-3 font-mono font-medium" style="color: var(--ink)">INV-0001</td>
                    <td class="px-4 py-3" style="color: var(--muted)">Sample Customer</td>
                    <td class="px-4 py-3" style="color: var(--muted)">Sample invoice for <b>${tab.label}</b></td>
