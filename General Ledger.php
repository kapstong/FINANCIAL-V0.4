  ...
  <div id="contextBar" class="sticky top-14 z-40 border-b border-[var(--ring)] bg-white/80 backdrop-blur">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-12 flex items-center justify-between">
      <div class="flex items-center gap-3">
        <span class="font-semibold" style="color: var(--ink)">General Ledger</span>
      </div>
            ...
            <div class="mt-6 space-y-6">
              ...
              <div class="bg-slate-50 border border-slate-200 rounded-lg p-4">
                <div class="flex flex-wrap gap-4 items-end">
                  ...
                  <div>
                    <label class="block text-sm font-medium mb-2" style="color: var(--muted)">Account Type</label>
                ...
                <table class="min-w-full text-sm">
                  <thead class="bg-slate-50 border-b border-slate-200">
                    <tr>
                      ...
                      <th class="text-left px-4 py-3 font-semibold" style="color: var(--ink)">Description</th>
                      <th class="text-right px-4 py-3 font-semibold" style="color: var(--ink)">Debit</th>
                      <th class="text-right px-4 py-3 font-semibold" style="color: var(--ink)">Credit</th>
                  ...
                  <tbody class="divide-y divide-slate-100">
                    ${data.map(row => `
                      <tr class="hover:bg-slate-50 transition-colors">
                        <td class="px-4 py-3" style="color: var(--ink)">${row.date}</td>
                        <td class="px-4 py-3 font-mono font-medium" style="color: var(--ink)">${row.ref}</td>
                        <td class="px-4 py-3" style="color: var(--muted)">${row.desc}</td>
                        <td class="px-4 py-3 text-right font-mono" style="color: var(--ink)">${row.debit > 0 ? fmtMoney(row.debit) : '-'}</td>
                        <td class="px-4 py-3 text-right font-mono" style="color: var(--ink)">${row.credit > 0 ? fmtMoney(row.credit) : '-'}</td>
            ...
            <div class="mt-6 space-y-6">
              ...
              <div class="bg-slate-50 border border-slate-200 rounded-lg p-4">
                <div class="flex flex-wrap gap-4 items-end">
                  ...
                  <div>
                    <label class="block text-sm font-medium mb-2" style="color: var(--muted)">Account Category</label>
                    <select class="w-40 px-3 py-2 border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
              ...
              <div class="overflow-x-auto border border-slate-200 rounded-lg">
                <table class="min-w-full text-sm">
                  <thead class="bg-slate-50 border-b border-slate-200">
                    <tr>
                      <th class="text-left px-4 py-3 font-semibold" style="color: var(--ink)">Account</th>
                      <th class="text-right px-4 py-3 font-semibold" style="color: var(--ink)">Debit Balance</th>
                      <th class="text-right px-4 py-3 font-semibold" style="color: var(--ink)">Credit Balance</th>
                      <th class="text-center px-4 py-3 font-semibold" style="color: var(--ink)">Actions</th>
                    </tr>
                  </thead>
                  <tbody class="divide-y divide-slate-100">
                    ${data.map(row => `
                      <tr class="hover:bg-slate-50 transition-colors">
                        <td class="px-4 py-3 font-medium" style="color: var(--ink)">${row.account}</td>
                        <td class="px-4 py-3 text-right font-mono" style="color: var(--ink)">${row.debit > 0 ? fmtMoney(row.debit) : '-'}</td>
                        <td class="px-4 py-3 text-right font-mono" style="color: var(--ink)">${row.credit > 0 ? fmtMoney(row.credit) : '-'}</td>
                        <td class="px-4 py-3 text-center">
          ...
          <section class="card p-5">
            ...
            <div class="mt-6 space-y-6">
              ...
              <div class="bg-slate-50 border border-slate-200 rounded-lg p-4">
                <div class="flex flex-wrap gap-4 items-end">
                  <div>
                    <label class="block text-sm font-medium mb-2" style="color: var(--muted)">Account</label>
                ...
                <table class="min-w-full text-sm">
                  <thead class="bg-slate-50 border-b border-slate-200">
                    <tr>
                      ...
                      <th class="text-right px-4 py-3 font-semibold" style="color: var(--ink)">Debit</th>
                      <th class="text-right px-4 py-3 font-semibold" style="color: var(--ink)">Credit</th>
                      <th class="text-right px-4 py-3 font-semibold" style="color: var(--ink)">Balance</th>
                      <th class="text-center px-4 py-3 font-semibold" style="color: var(--ink)">Actions</th>
                    </tr>
                  </thead>
                  <tbody class="divide-y divide-slate-100">
                    ${data.map(row => `
                      <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="px-4 py-3 text-right font-mono" style="color: var(--ink)">${row.debit > 0 ? fmtMoney(row.debit) : '-'}</td>
                        <td class="px-4 py-3 text-right font-mono" style="color: var(--ink)">${row.credit > 0 ? fmtMoney(row.credit) : '-'}</td>
                        <td class="px-4 py-3 text-right font-mono font-semibold" style="color: var(--ink)">${fmtMoney(row.balance)}</td>
                        <td class="px-4 py-3 text-center">
                          <button class="text-blue-600 hover:text-blue-800 text-sm font-medium px-2 py-1 rounded hover:bg-blue-50">View</button>
                        </td>
                      </tr>
